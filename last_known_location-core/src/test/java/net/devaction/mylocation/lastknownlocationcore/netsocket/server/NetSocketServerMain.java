 ...
 * since December 2018
 */
public class NetSocketServerMain implements sun.misc.SignalHandler{
    private static final Logger log = LoggerFactory.getLogger(NetSocketServerMain.class);
    ...
    public static void main(String[] args){
        ...
        Launcher.executeCommand("run", NetSocketServerVerticle.class.getName());   

        new NetSocketServerMain().run();        
    }

    private NetSocketServerMain(){}
